...
É importante mencionar que nem todos os atributos são obrigatórios durante a inserção e atualização de dados. Nesses casos, podem ser usadas duas barras seguidas para pular um parâmetro, ou se o parâmetro indesejado for o último, bastaria ignorar a sua existência por completo.
...
\begin{itemize}
    ...
    \item \texttt{UPDATE} - \url{https://api2.opessoa.com.br/ProjetoBD/AlunosController/update/200012345//Joseph%20dos%20Testes}
